...
class BERTopic:
    ...
    def _select_embedding_model(self) -> SentenceTransformer:
        ...
        if self.custom_embeddings and self.allow_st_model and not self.huggingface_model:
            return SentenceTransformer("xlm-r-bert-base-nli-stsb-mean-tokens")

        # Select embedding model based on language
        elif self.language and not self.huggingface_model:
        ...
        elif self.embedding_model and not self.huggingface_model:
        ...
        elif self.embedding_model and self.huggingface_model:
            word_embedding_model = models.DistilBERT(self.embedding_model)
